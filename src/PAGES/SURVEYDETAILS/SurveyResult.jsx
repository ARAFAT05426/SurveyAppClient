    ...
    <section className="bg-white p-8 rounded-lg shadow-xl">
      ...
      <div className="mb-8">
        <div className="flex justify-between">
          <h3 className="text-2xl font-semibold mb-6 text-primary/80">
            Questions & Results
          </h3>
          <span className="font-bold text-xl text-primary">Total voter:  {survey.voters.length}</span>
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center bg-gray-100 p-4 rounded-lg shadow-md">
          <img
            src={survey.host.image}
            alt={survey.host.name}
