import { FaUser, FaDollarSign, FaUserShield, FaVoteYea, FaRegComments } from "react-icons/fa";
...
const UserStatistics = () => {
  ...
  const { data: statData = {}, isLoading } = useQuery({
    queryKey: ["proStatData"],
    queryFn: async () => {
      const { data } = await axiosSecure.get(`/proStat/${user?.email}`);
      return data;
    },
  });
      ...
      <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div className="relative flex flex-col rounded-xl bg-gradient-to-br from-blue-600 to-blue-400 text-white shadow-lg">
          ...
          <div className="p-4 text-right">
            <p className="block text-sm font-normal text-gray-200">Name</p>
            <h4 className="block text-2xl font-semibold">{name}</h4>
          </div>
        </div>
        ...
        <div className="relative flex flex-col rounded-xl bg-gradient-to-br from-green-600 to-green-400 text-white shadow-lg">
          ...
          <div className="p-4 text-right">
            <p className="block text-sm font-normal text-gray-200">Email</p>
            <h4 className="block text-2xl font-semibold">{email}</h4>
          </div>
        </div>
        ...
        <div className="relative flex flex-col rounded-xl bg-gradient-to-br from-purple-600 to-purple-400 text-white shadow-lg">
          ...
          <div className="p-4 text-right">
            <p className="block text-sm font-normal text-gray-200">Role</p>
            <h4 className="block text-2xl font-semibold">{role}</h4>
          </div>
        </div>
        ...
        <div className="relative flex flex-col rounded-xl bg-gradient-to-br from-orange-600 to-orange-400 text-white shadow-lg">
          ...
          <div className="p-4 text-right">
            ...
            <h4 className="block text-2xl font-semibold">{accountAge}</h4>
          </div>
        </div>
        ...
        <div className="relative flex flex-col rounded-xl bg-gradient-to-br from-red-600 to-red-400 text-white shadow-lg">
          ...
          <div className="p-4 text-right">
            <p className="block text-sm font-normal text-gray-200">Payment</p>
        ...
        <div className="relative flex flex-col rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-400 text-white shadow-lg">
          ...
          <div className="p-4 text-right">
            <p className="block text-sm font-normal text-gray-200">Voted</p>
            <h4 className="block text-2xl font-semibold">{voted}</h4>
          </div>
        </div>

        {/* Commented Card */}
        <div className="relative flex flex-col rounded-xl bg-gradient-to-br from-yellow-600 to-yellow-400 text-white shadow-lg">
          <div className="mx-4 rounded-xl bg-gradient-to-tr shadow-lg absolute -mt-4 grid h-16 w-16 place-items-center from-yellow-600 to-yellow-400">
            <FaRegComments className="w-6 h-6 text-white" />
          </div>
          <div className="p-4 text-right">
            <p className="block text-sm font-normal text-gray-200">Commented</p>
            <h4 className="block text-2xl font-semibold">{commented}</h4>
          </div>
        </div>
      </div>
    </div>
